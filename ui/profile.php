...
<title>iwanshokoto. Profile of <?php echo $_SESSION['TheUser'];?></title>
</head>
...
<link rel="stylesheet" type="text/css" href="<?php echo $pathPrefix;?>stylesheet/dialogs/selectavatardialog.css"/>
...
<script src="<?php echo $pathPrefix?>scripts/profile.js" type="text/javascript"></script>
            ...
            <div id="mainRightCol">
            	<div id="rightcolcontentholder">
            		<div id="rightcolheading">
                		<div id="rightcoldescription"><label style="color:#333333;">Profile of </label><label style="color:#007DB8"><?php echo $_SESSION['TheUser'];?></label></div>
                    ...
                    <div id="profiletopsection">
                    	<div id="userprofileimageholderbound">
                        	...
                        	<div id="userprofileimageholder">
                            	<?php
									if ($memPic = $theMember->getMemberPic(200, 200, 75, true))
										echo $memPic;
									else
									{
                        ...
                        <div id="userprofileimagesidemaindetails">
                        	<div style="height:7px"></div>
                        	<div class="userprofiledetailholder"><label class="updlabel">Username:</label> <label class="updddata"><?php echo $_SESSION['TheUser'];?></label><div style="clear:both"></div></div>
